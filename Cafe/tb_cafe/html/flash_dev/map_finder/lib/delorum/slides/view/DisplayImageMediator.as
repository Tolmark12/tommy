...
<<<<<<< HEAD:html/flash_dev/map_finder/lib/delorum/slides/view/DisplayImageMediator.as
			ldr.onComplete = _showNewSlide;
=======
			ldr.addEventListener(Event.COMPLETE, _showNewSlide);
>>>>>>> 96d75a80ac886728cc3d8056f372b0bd26cee4d9:html/flash_dev/map_finder/lib/delorum/slides/view/DisplayImageMediator.as
			ldr.loadItem();
		}
		else
		{
