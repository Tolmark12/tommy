...
public class ErrorMachine
{
	...
	*	@default    ErrorMachine.QUIET 							 */
	...
	public static function initForExternalJavascript (  ):void
	{
		...
		{
			ExternalInterface.addCallback( "addErrorToLog",   ErrorMachine.addErrorToLog 	);
			ExternalInterface.addCallback( "addMessageToLog", ErrorMachine.addMessageToLog 	);
			ExternalInterface.addCallback( "printErrors",     ErrorMachine.printErrors 		);
			ExternalInterface.addCallback( "printMessages",   ErrorMachine.printMessages 	);
			ExternalInterface.addCallback( "print",  		  ErrorMachine.print			);	
			ExternalInterface.addCallback( "trace",  		  ErrorMachine.print			);	
			ExternalInterface.addCallback( "echo",  		  ErrorMachine.print			);	
		}
	}
	...
	*/
	...
	{
		return ( $stage.loaderInfo.url.indexOf("http://") == 0 || $stage.loaderInfo.url.indexOf(".swf") == -1  )? true : false;
	}
