...
Sprout::ProjectModel.setup do |model|
  model.project_name  = 'FurnitureViewer'
  # Default Values:
  # model.src_dir       = 'src'
  # model.lib_dir       = 'lib'
  # model.swc_dir       = 'lib'
  ...
  model.language      = 'as3'
  model.output        = "#{model.bin_dir}/FurnitureViewer.swf"
...
# Uncomment to use the Flex 3 SDK
  ...
  t.input                     = "#{model.src_dir}/FurnitureViewer.as"
  t.source_path               << model.asset_dir
  t.source_path               << "#{model.lib_dir}/"
  t.library_path              << "./FurnitureViewer.swc"
...
# Uncomment to use the Flex 3 SDK
  ...
  t.input                     = "#{model.src_dir}/FurnitureViewerRunner.as"
  t.source_path               << "#{model.lib_dir}/"
